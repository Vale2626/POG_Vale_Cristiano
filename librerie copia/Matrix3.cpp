...
Vector3f Matrix3 :: prod_mat_vet(Vector3f &other)
{
    ...
    Vector3f Vettore_risultante(v1, v2, v3);
...
Matrix3 Matrix3 :: Trasposta(const Matrix3 &other)
{
...
float Matrix3 :: Determinante(Matrix3 &other)
{
    float det;
...
Vector3f Matrix3 :: get_riga1()
{
    float x1 = a;
    float x2 = b;
    float x3 = c;

    Vector3f vettore(x1, x2, x3);
    return vettore;
}

Vector3f Matrix3 :: get_riga2()
{
    float x1 = d;
    float x2 = e;
    float x3 = f;
...
void Matrix3 :: set_riga1(Vector3f &other)
{
    a = other.getX();
    b = other.getY();
    c = other.getZ();
...
void Matrix3 :: set_riga2(Vector3f &other)
{
    d = other.getX();
    e = other.getY();
    f = other.getZ();
...
void Matrix3 :: set_riga3(Vector3f &other)
{
    g = other.getX();
    h = other.getY();
    i = other.getZ();
...
void Matrix3 :: set_col1(Vector3f &other)
{
    a = other.getX();
    d = other.getY();
    g = other.getZ();
...
void Matrix3 :: set_col2(Vector3f &other)
{
    b = other.getX();
    e = other.getY();
    h = other.getZ();
...
void Matrix3 :: set_col3(Vector3f &other)
{
    c = other.getX();
    f = other.getY();
    i = other.getZ();
