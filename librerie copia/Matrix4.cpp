...
Vector4f Matrix4 :: prod_mat_vet(Vector4f &other)
{
    ...
    Vector4f Vettore_risultante(v1, v2, v3, v4);
...
Matrix4 Matrix4 :: Trasposta(const Matrix4 &other)
{
    float a1_1, a1_2, a1_3, a1_4, a2_1, a2_2, a2_3, a2_4, a3_1, a3_2, a3_3, a3_4, a4_1, a4_2, a4_3, a4_4;
...
float Matrix4 :: Determinante(Matrix4 &other)           //conti sbagliati?
{
    float det;
...
Vector4f Matrix4 :: get_riga1()
{
    ...
    Vector4f vettore(x1, x2, x3, x4);
    return vettore;
}

Vector4f Matrix4 :: get_riga2()
{
    float x1 = e;
    float x2 = f;
    float x3 = g;
...
void Matrix4 :: set_riga1(Vector4f &other)
{
    a = other.getX();
    b = other.getY();
    c = other.getZ();
...
void Matrix4 :: set_riga2(Vector4f &other)
{
    e = other.getX();
    f = other.getY();
    g = other.getZ();
...
void Matrix4 :: set_riga3(Vector4f &other)
{
    i = other.getX();
    j = other.getY();
    k = other.getZ();
...
void Matrix4 :: set_riga4(Vector4f &other)
{
    m = other.getX();
    n = other.getY();
    o = other.getZ();
...
void Matrix4 :: set_col1(Vector4f &other)
{
    a = other.getX();
    e = other.getY();
    l = other.getZ();
...
void Matrix4 :: set_col2(Vector4f &other)
{
    b = other.getX();
    f = other.getY();
    j = other.getZ();
...
void Matrix4 :: set_col3(Vector4f &other)
{
    c = other.getX();
    g = other.getY();
    k = other.getZ();
...
void Matrix4 :: set_col4(Vector4f &other)
{
    d = other.getX();
    h = other.getY();
    l = other.getZ();
