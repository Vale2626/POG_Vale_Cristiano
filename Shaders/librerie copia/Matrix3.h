...
class Matrix3
{
    ...
    public:
        ...
        Vector3f prod_mat_vet(Vector3f &other);       //restituisce un vettore
        Matrix3 prod_mat_mat(Matrix3 &other);         //restituisce una matrice
        Matrix3 Trasposta(const Matrix3 &other);
        Matrix3 Inversa(Matrix3 &other);
        float Determinante(Matrix3 &other);
        ...
        Vector3f get_riga1();
        Vector3f get_riga2();
        Vector3f get_riga3();               //le funzioni get restituiscono un Vettore a 3 componenti
        Vector3f get_col1();
        Vector3f get_col2();
        Vector3f get_col3();

        void set_riga1(Vector3f &other); 
        void set_riga2(Vector3f &other);               //vector3f &other sono i parametri che gli passo alle funzioni set
        void set_riga3(Vector3f &other);
        void set_col1(Vector3f &other);
        void set_col2(Vector3f &other);
        void set_col3(Vector3f &other);
